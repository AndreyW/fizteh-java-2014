package ru.fizteh.fivt.students.MaksimovAndrey.Storable.test;
...
import ru.fizteh.fivt.students.MaksimovAndrey.Storable.StructuredTable;
import ru.fizteh.fivt.students.MaksimovAndrey.Storable.StructuredTableProviderFactory;
import ru.fizteh.fivt.students.MaksimovAndrey.Storable.structured.*;
...
public class StructuredTableTest {
    ...
    public void testPutAndGet() {
        Object[] values = {1, 2L, 3.2f, 4.4, true, null, (Byte) (byte) 3};
        ...
        assertEquals(ret.getColumnAt(1), 2L);
        value.setColumnAt(0, 2);
        Storeable old = table.put("key", value);
        assertEquals(old.getColumnAt(0), 1);
    ...
    public void testPutAndRemove() {
        ...
        assertEquals(old.getColumnAt(0), 1);
        assertEquals(old.getColumnAt(1), 2L);
    ...
    public void testIncorrectPut() throws IOException {
        ...
        Object[] values = {false, 2L, 3.2f, 4.4, true, null, (Byte) (byte) 3};
    ...
    public void testUnsavedChanges() throws IOException {
        ...
        table.put("3", value);
        table.remove("1");
        assertEquals(((StructuredTable) table).getNumberOfUncommittedChanges(), 4);
        table.commit();
        assertEquals(((StructuredTable) table).getNumberOfUncommittedChanges(), 0);
    }
}
