...
/**
 * Бросается при попытке извлечь из колонки {@link ru.fizteh.fivt.students.MaksimovAndrey.Parellel.StoreableForParallel.structured.Storeable} значение не соответствующего типа,
